...
```console
$ cargo run --quiet -- generate-sk ; echo
...
```console
$ cargo run --quiet -- generate-seed | cargo run --quiet -- derive-sk -f - ; echo
...
$ echo -n 7fe54ac4449ef108b4717620b36085f300de9758decd6ad240b24b37d3f3dfc5 | cargo run --quiet -- derive-sk --file -; echo
...
$ cargo run --quiet -- derive-sk --file seed; echo

```
...
```console
$ echo -n 7fe54ac4449ef108b4717620b36085f300de9758decd6ad240b24b37d3f3dfc5 | cargo run --quiet -- derive-sk --file - > sk
$ cargo run --quiet -- derive-pk --file sk > pk
$ echo -n "msg" | cargo run --quiet -- sign -f sk
...
$ echo -n "msg" | cargo run --quiet -- sign -f sk > sig
$ echo -n "msg" | cargo run --quiet -- verify -f pk -p 0 -s sig
OK
$ echo -n "msg" | cargo run --quiet -- verify -f pk -p 1 -s sig
Fail
$ echo "msg" | cargo run --quiet -- verify -f pk -p 0 -s sig
Fail
```
...
$ cargo run --quiet -- update -f sk > sk1
$ echo -n "msg" | cargo run --quiet -- sign -f sk1 > sig1
$ echo -n "msg" | cargo run --quiet -- verify -f pk -p 0 -s sig1
Fail
$ echo -n "msg" | cargo run --quiet -- verify -f pk -p 1 -s sig1
OK
```
